...
class PatientRegisterAuthForm extends ConsumerStatefulWidget {
  const PatientRegisterAuthForm({
    super.key,
...
class _MyAuthFormState extends ConsumerState<PatientRegisterAuthForm> {
