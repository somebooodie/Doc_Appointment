...
//               onPressed: () async {
//                 if (formKey.currentState!.validate()) {
//                   // Make sure to include logic to save the docID from the TextField before calling register
//                   authStateProvider
//                       .register(
//                     email: authFormController.email,
//                     userName: authFormController.userName,
...
//                         .docID, // Ensure this field exists in your authFormController
//                   )
//                       .then((result) {
//                     if (result == true) {
//                       context.goNamed(MyNamedRoutes.homepage);
